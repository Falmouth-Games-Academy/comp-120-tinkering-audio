...
# This section initialises pygame and sets the resolution of the monitor used
pygame.init()
...
# This exits the application upon pressing the exit button and on pressing a key, plays the tone
done = False
while not done:
