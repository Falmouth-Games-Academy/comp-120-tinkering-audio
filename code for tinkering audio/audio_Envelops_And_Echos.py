...
def echoes(delay, num):                                             
  ...
  s1 = getLength(sound)                                              #make empty sound
  s2 = s1 + (delay * num)                                            
  canvas = makeEmptySound(s2)                                        #define sound length
  ...
  for echoCount in range(1, num):                                   
    ...
    for posns1 in range(0, s1):
      ...
      setSampleValueAt(canvas, posns2, values1 + values2)           #sets the sample to the canvas
  play(canvas)